...
![](./women-Pima-shinny-game-field-hockey.jpg){width=80%}
...
**Relacyjne bazy danych**: struktura danych zaprojektowana do efektywnego
przechowywania i przetwarzania ogromych zbiorów danych. Baza danych
składa się z połączonych (logicznie) tabel.

**SQL**: standardowy język zapytań relacyjnych baz danych. Ponieważ współcześnie
ogromne zbiorami danych są powszechne, wiele programów implementuje
zwykle częściowo SQL, np Excel (`filter`, `select`, `join`).
